#!/usr/bin/env python3
"""
Recupero codici sconto Dr. Max da shopilo.it
Sursa: https://shopilo.it/negozi/drmax.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/drmax.it"
STORE_NAME = "Dr. Max"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Dr. Max da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-drmax)"
    }
    try:
